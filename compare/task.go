...
func genJobs(c uint) []Job {
	...
	if c&Index != 0 {
		jobs = append(jobs, &nsFilterIndexJob{}, &indexJob{})
	}
	if c&Count != 0 {
		jobs = append(jobs, &nsFilterBaseJob{}, &countCompareJob{})
	}
	if c&Partial != 0 {
		jobs = append(jobs, &nsFilterSpecifiedJob{}, &countCompareJob{}, &staticDataJob{}, &dynamicDataJob{})
	} else if c&Data != 0 {
		jobs = append(jobs, &nsFilterBaseJob{}, &countCompareJob{}, &staticDataJob{}, &dynamicDataJob{})
	}
